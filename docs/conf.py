# pytest-amaranth-sim documentation build configuration file, created by
...
project = 'pytest-amaranth-sim'
copyright = '2024-2026, William D. Jones'
...
latex_documents = [
    (master_doc, 'pytest-cookiecutterplugin_name.tex',
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name',
     'pytest-amaranth-sim Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pytest-cookiecutterplugin_name',
     'pytest-amaranth-sim Documentation', author,
     'pytest-cookiecutterplugin_name', 'One line description of project.',
     'Miscellaneous'),
]
